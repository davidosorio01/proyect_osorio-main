...
<div>  
    ...
    <div class="container">  
        <div class="header">  
            <h1>Inicios del Béisbol</h1>  
        </div>  
        <div class="video-container">  
            <iframe width="560" height="315" src="https://www.youtube.com/embed/zv8ONaHtYjc?si=Ch8ZBM41LaXule8M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>  
    </div>   
    <a href="/beisbol/beisbol1" data-sveltekit-reload="" data-sveltekit-preload-data="tap">  
